...
implements IGererListeExpert {
	...
	/** Le chargeur de donnees */
	private IChargerExpert chargeurExperts;
	
	public GestionnaireListeExperts(final IChargerExpert pChargeur) {
		chargeurExperts = pChargeur;
	}
	...
	public void charger() {
		...
		_listTravail = chargeurExperts.chargerExperts();
